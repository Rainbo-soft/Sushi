    ...
    <div>
      {Fruits.map((fruit) => (
        <>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-10 px-5">
            {fruit.Items.map((item, index) => (
              ...
              >
                <div className="overflow-hidden  aspect-video bg-red-400 cursor-pointer rounded-sm relative group h-full w-full">
                  <div className="rounded-sm  transition duration-300 ease-in-out cursor-pointer absolute from-black/80 to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white flex items-end z-10">
                    <div className="">
